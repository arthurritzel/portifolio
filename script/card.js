/* <div class="card">
    <div class="content">
        <div class="front">
            ...
            <p class="card_cara">Características:</p>
            <div class="list">
                <li>Web</li>
                <li>json-server</li>
                <li>restAPI</li>
        ...
        <div class="back">
            <p>Acesse o <br> código</p>
            <a class="btn btn-primary" href="https://github.com/arthurritzel/crud-js-api" role="button" target="_blank">Github</a>
        </div>
    </div>
</div> */
